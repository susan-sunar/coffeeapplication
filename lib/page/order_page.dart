...
import 'package:coffeeapplication/controller/ordercontroller.dart';
import 'package:coffeeapplication/goggle_fonts.dart';
import 'package:coffeeapplication/model/coffee_class.dart';
import 'package:coffeeapplication/page/delivary_location.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Brewed Awakening', style: myStyle(18,Colors.black,FontWeight.bold)),
                Text('Spk.Mooson No. 743, Bilzen, Tanjungbalai.',
